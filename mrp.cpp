...
for(xml_node ref = cur.first_child(); ref; ref = ref.next_sibling() ){              //1ère boucle
 for(xml_node ref2 = ref.first_child(); ref2; ref2 = ref2.next_sibling() ){         //2ème boucle
   if (strcmp(ref2.name(),"mail")==0){
     ...
     cout << "dans les days: " << ref2.child_value() << endl;
     // refinery.days_push_back(ref2.child_value());
   }
...
cout << "web: " << refinery.get_web() << ", mail: " << refinery.get_mail() <<endl;

// for(xml_node ref = cur.first_child(); ref; ref = ref.next_sibling() ){
//   cout << "1er boucle: " << ref.name() << endl;
//   for(xml_node ref2 = ref.first_child(); ref2; ref2 = ref2.next_sibling() ){
//     cout << "   2ème boucle:" << ref2.name() << endl;
//     for(xml_node ref3 = ref2.first_child(); ref3; ref3 = ref3.next_sibling() ){
//       cout << "       3ème boucle:" << ref3.name();
//       cout << "  Valeur: " << ref3.child_value() << endl ;
//   }
//  }
// }
